...
source /Users/ivankarpenko/src/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
...
'-h[Print help information]' \
'--help[Print help information]' \
'::name -- The name of preset to be printed:(no-runtime-versions bracketed-segments plain-text-symbols pastel-powerline pure-preset nerd-font-symbols)' \
&& ret=0
;;
(print-config)
_arguments "${_arguments_options[@]}" \
